namespace TestingLayer
{
    ...
    public class DrivingLicenseTests
    {
      /*  private DrivingLicenseContext ctx = new DrivingLicenseContext(MVRSystemDBManager.GetContext());
        ...
        {
            Card card = new Card("custom3", "custom2gn", "none", "customfname", "custommname", "customlname", "m", "01.01.2001", "31.12.2050", "Plovdiv", "Plovdiv", "Plovdiv", "Plovdiv", "ul. Spas Tzilkov 5", 203, "black", "MVR Sofiq", "02.01.2021", "213213", "3123124", "3123123");
